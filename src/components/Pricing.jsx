...
function Pricing() {
  ...
  const packages = [
    {
      ...
      red: "/src/assets/red_ball.png",
      green: "/src/assets/green_ball.png",
    },
    {
      name: "Advanced",
      monthlyPrice: 39,
  ...
  return (
    <>
      <div className="mb:px-14 p-4 max-w-screen mx-auto py-10">
        <div className="text-center" id="pricing">
          ...
          <p className="text-tartiary md:w-1/3 mx-auto px-4">
            Lorem ipsum dolor sit amet consectetur adipisicing el itmet
          ...
          <div className="mt-16">
            ...
            >
              ...
              <div className="w-12 h-6 bg-gray-300 rounded-full transition duration-200 ease-in-out">
                <div
            ...
            >
              ...
              <ul className="mt-4 space-y-2 px-4">
                ...
                <li className="flex gap-2 items-center">
                  <img
                    src={
                      pkg.name == "Advanced" || pkg.name == "Start"
                        ? pkg.red
                        : pkg.green
                    }
                    alt=""
